    ...
    <div className="space-y-6" data-testid="ticker-messages-tab">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            أضف وعدّل الرسائل التي تظهر في الشريط المتحرك أعلى الصفحة
          </p>
        </div>
          ...
          >
            {messages.map((message) => (
              <Reorder.Item
                key={message.id}
                value={message}
                className="flex items-center gap-3 p-4 bg-white hover:bg-gray-50 cursor-grab active:cursor-grabbing"
              >
                ...
                <input
                  ...
                  className="flex-1 px-3 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-[#FF6B00]/20 focus:border-[#FF6B00] outline-none"
                />
      ...
      <div className="bg-blue-50 rounded-xl p-4">
        ...
        <ul className="text-sm text-blue-700 space-y-1">
          ...
          <li>• ضع شارة "حصري" على العروض المميزة فقط</li>
          <li>• يمكنك سحب الرسائل لتغيير ترتيبها</li>
        </ul>
      </div>
    </div>
  );
