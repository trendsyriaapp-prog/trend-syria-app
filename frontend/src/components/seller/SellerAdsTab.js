    ...
    <section className="space-y-4" data-testid="seller-ads-tab">
      ...
      {ads.length === 0 ? (
        <div className="bg-white rounded-xl p-8 text-center border border-gray-200">
          ...
          <h3 className="font-bold text-gray-700 mb-1">لا توجد إعلانات</h3>
          <p className="text-gray-500 text-sm mb-4">أنشئ إعلانك الأول لتظهر منتجاتك للمزيد من العملاء</p>
          <button
            onClick={() => setShowCreateModal(true)}
