    ...
    return (
      <AnimatePresence>
        <motion.div
          ...
          exit={{ y: -50, opacity: 0 }}
          className="bg-gradient-to-r from-green-500 to-emerald-500 text-white px-4 py-2 flex items-center justify-between shadow-lg z-40 sticky top-[56px] left-0 right-0"
  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        animate={{ y: 0, opacity: 1 }}
        exit={{ y: -50, opacity: 0 }}
        className="bg-gradient-to-r from-[#FF6B00] to-[#FF8C00] text-white px-4 py-2 shadow-md z-40 sticky top-[56px] left-0 right-0"
