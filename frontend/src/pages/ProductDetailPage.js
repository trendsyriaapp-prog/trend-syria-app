...
const SIZE_GUIDES = {
  ...
  kids_age: {
    title: 'دليل مقاسات الأطفال حسب العمر',
    headers: ['العمر', 'الطول (سم)', 'الوزن (كغ)', 'الصدر (سم)'],
    rows: [
      ['0-3 شهور', '50-62', '3-6', '40-44'],
      ['3-6 شهور', '62-68', '6-8', '44-46'],
      ['6-12 شهر', '68-80', '8-10', '46-48'],
      ['1-2 سنة', '80-92', '10-13', '48-52'],
      ['2-3 سنوات', '92-98', '13-15', '52-54'],
      ['3-4 سنوات', '98-104', '15-17', '54-56'],
      ['4-5 سنوات', '104-110', '17-20', '56-58'],
      ['5-6 سنوات', '110-116', '20-22', '58-60'],
      ['6-7 سنوات', '116-122', '22-25', '60-62'],
      ['7-8 سنوات', '122-128', '25-28', '62-65'],
      ['8-10 سنوات', '128-140', '28-35', '65-70'],
      ['10-12 سنة', '140-152', '35-42', '70-76'],
    ]
  },
  kids_shoes: {
              ...
              <div className="mb-2 p-2 bg-gray-50 rounded-lg border border-gray-200">
                <div className="flex items-center justify-between mb-1.5">
                  <h4 className="font-bold text-gray-900 text-[11px]">
                    ...
                    {product.size_type === 'kids_age' && ' (أطفال - حسب العمر)'}
