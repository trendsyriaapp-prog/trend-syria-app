...
import { 
  ...
  MessageCircle, ChevronLeft, Camera, X, Send, Loader2, Store, Play, Zap, Share2
} from 'lucide-react';
    ...
    <div className="min-h-screen pb-32 md:pb-10 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 py-4">
        ...
        <div className="flex flex-col">
          ...
          >
            <h1 className="text-base md:text-lg font-bold mb-1 text-gray-900" data-testid="product-name">
              {product.name}
            </h1>
