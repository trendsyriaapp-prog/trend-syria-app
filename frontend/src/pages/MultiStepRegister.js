            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                ...
                className={`p-3 rounded-xl border-2 ${
                  formData.user_type === 'seller' ? 'border-[#FF6B00] bg-white' : 'border-gray-200 bg-white'
                }`}
              >
                <Store className="w-6 h-6 mx-auto mb-1 text-[#FF6B00]" />
                <p className="text-xs">بائع منتجات</p>
              </button>
              <button
                type="button"
                onClick={() => {
                ...
                className={`p-3 rounded-xl border-2 ${
                  formData.user_type === 'food_seller' ? 'border-[#FF6B00] bg-white' : 'border-gray-200 bg-white'
                }`}
              >
                <Utensils className="w-6 h-6 mx-auto mb-1 text-[#FF6B00]" />
                <p className="text-xs">مطعم / طعام</p>
              </button>
            </div>
          </motion.div>
        )}
