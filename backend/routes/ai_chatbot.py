...
【التسجيل كبائع】
- يحتاج: هوية شخصية + سجل تجاري
- يتم إرسال الطلب للمدير للمراجعة والموافقة أو الرفض
- العمولة: 7-12% حسب الصنف
- لا رسوم اشتراك شهرية

【التسجيل كموظف توصيل】
- يحتاج: هوية + رخصة قيادة
- الأرباح: تُحسب على أساس المسافة المقطوعة (وليس عدد الطلبات)
- ساعات مرنة
- يتم إرسال الطلب للمدير للمراجعة والموافقة
