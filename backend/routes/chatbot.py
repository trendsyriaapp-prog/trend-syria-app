...
FAQ_RESPONSES = {
    ...
    "استرجاع المبلغ|ارجاع المبلغ|إرجاع المبلغ|رد المال|رد الفلوس|استرداد المبلغ": {
        "response": "لاسترجاع المبلغ (في حالة رفض الاستلام):\n\n• إذا كان الدفع بالمحفظة: يُرد خلال 24-48 ساعة ✅\n• إذا كان الدفع نقداً عند الاستلام: لم يتم دفع شيء\n• إذا كان بشام كاش: يُرد خلال 3-5 أيام\n\n⚠️ تذكر: يجب رفض الاستلام عند التسليم لاسترداد المبلغ",
