...
FAQ_RESPONSES = {
    ...
    "استرجاع المبلغ|ارجاع المبلغ|إرجاع المبلغ|رد المال|رد الفلوس": {
        "response": "لاسترجاع المبلغ:\n• إذا كان الدفع بالمحفظة: يُرد خلال 24 ساعة ✅\n• إذا كان الدفع نقداً: يُرد عند استلام المنتج المُرجع\n• إذا كان بشام كاش: يُرد خلال 3-5 أيام\n\n💡 تأكد من إتمام طلب الإرجاع أولاً",
        "quick_replies": ["كيف أرجع منتج؟", "التواصل مع الدعم"],
        "category": "returns"
    },
    "غيرت رأيي|غيرت رايي|لا اريده|لا أريده": {
        "response": "لا مشكلة! يمكنك إرجاع المنتج إذا:\n✅ لم تفتح العلبة/الغلاف\n✅ خلال 7 أيام من الاستلام\n\n⚠️ ملاحظة: في هذه الحالة تتحمل أنت تكلفة شحن الإرجاع",
        "quick_replies": ["كيف أرجع منتج؟", "تكلفة شحن الإرجاع"],
        "category": "returns"
    },
    ...
    "كم الراتب|راتب التوصيل|ارباح التوصيل|أرباح التوصيل": {
        "response": "أرباح موظف التوصيل:\n💵 5,000 ل.س لكل طلب يتم توصيله\n🎯 مكافآت إضافية على الأداء المميز\n📈 لا حد أقصى للأرباح!\n\n💡 كلما وصّلت أكثر، ربحت أكثر!",
