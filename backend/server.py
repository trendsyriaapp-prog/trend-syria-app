...
async def calculate_cart_shipping(customer_city: str, user: dict = Depends(get_current_user)):
    ...
    # جمع معلومات المنتجات والبائعين
    seller_ids = set()
    seller_cities = {}
    cart_total = 0
    ...
    # متجر واحد - التحقق من المحافظة والمبلغ
